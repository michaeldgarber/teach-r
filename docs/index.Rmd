...
3.  **R for spatial data wrangling: using sf to wrangle OpenStreetMap-downloaded pharmacies in Atlanta and assess population living nearby**
    ...
    Part 1: <https://michaeldgarber.github.io/teach-r/3-sf-atl-pharm.html>

    Part 2: <https://michaeldgarber.github.io/teach-r/3-sf-atl-pharm-part-2.html>
...
4.  **Making static and interactive maps in R**
    ...
    Link: <https://michaeldgarber.github.io/teach-r/4-map-making.html> (work in progress)
...
5.  **Monte Carlo simulations and boots with the purrr::map_dfr()**
    ...
    Link: <https://michaeldgarber.github.io/teach-r/5-monte-carlo-boot-purrr.html>
...
-   Modules covered:
    ...
    -   <https://michaeldgarber.github.io/teach-r/0-manage-packages.html>

    -   <https://michaeldgarber.github.io/teach-r/3-sf-atl-pharm-part-2.html>
...
-   Modules covered:
    ...
    -   <https://michaeldgarber.github.io/teach-r/5-monte-carlo-boot-purrr.html>

    -   <https://michaeldgarber.github.io/teach-r/4-map-making.html>
