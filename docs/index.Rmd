...
3.  **Working with spatial data in R: applying spatial operations from the sf package to an example analysis of pharmacies downloaded from OpenStreetMap**
    ...
    Link for Part 1: <https://michaeldgarber.github.io/teach-r/3-sf-atl-pharm.html>

    Link for Part 2: <https://michaeldgarber.github.io/teach-r/3-sf-atl-pharm-part-2.html>
