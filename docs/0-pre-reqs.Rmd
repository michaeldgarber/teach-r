...
On a particular line of code, anything followed by a `#` is considered by R to be a comment and will not be evaluated as code. Comments are a way to annotate your code to your future self or other collaborators. Text considered by R to be comments will change to a different color. In the default R Studio setup, they're green.
...
For exampleAnything in your code followed by a \# is considered by R to
...
Fortunately, there's a very simple solution to these issues: Use the [here](https://here.r-lib.org/) package. This package creates a working directory [relative]{.underline} to the location of the R project (described below) you are working in. This means that wherever your project is in the folder structure of your computer, the `here()` function to define your working directory and thus any read/write commands that rely on it will just work.
