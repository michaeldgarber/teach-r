...
It's worth giving some thought to the project's folder structure. There are no hard-and-fast rules, but I, minimally, have taken [this advice](https://chrisvoncsefalvay.com/2018/08/09/structuring-r-projects/) and typically create separate folders for code, input data that should never be modified, and processed data that is a result of code.
