...
-   Assess sociodemographic distribution of living near a pharmacy.

-   Visualize the pharmacies and the sociodemographic characteristics on the same map using tmap (<https://mkram01.github.io/EPI563-SpatialEPI/intro-tmap.html>) and compare with mapview, and ggplot2.
