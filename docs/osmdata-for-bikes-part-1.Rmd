...
The goal of this demo series ([part 1](https://michaeldgarber.github.io/teach-r/osmdata-for-bikes-part-1) and [part 2](https://michaeldgarber.github.io/teach-r/osmdata-for-bikes-part-2)) is to illustrate use of an R package, **osmdata**, to download OpenStreetMap data, with a focus on gathering bicycle infrastructure in Atlanta. The present document focuses on the data structure.

# Outline

-   Overview of OpenStreetMap's data structure
-   Overview of OpenStreetMap's representation of bicycle infrastructure data
-   Use of osmdata to download OpenStreetMap data ([part 2](https://michaeldgarber.github.io/teach-r/osmdata-for-bikes-part-2))
...
knitr::include_graphics("images/RUG-osmdata-pres/g-photos-edits/conventional-bike-lane-edgewood.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/g-photos-edits/buffered-rda.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/g-photos-edits/luckie-st-posts.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/g-photos-edits/sharrow-clifton.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/g-photos-edits/beltline-2017.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/osm-interface-edgewood.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/osm-interface-11-switchbacks.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/osm-interface-beltline-eastside.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/osm-interface-piedmont-footway.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/osm-interface-clifton.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/osm-bike-table.png")
```
...
knitr::include_graphics("images/RUG-osmdata-pres/osm-interface-luckie-st.png")
```

```{r image-freedom, echo=FALSE, fig.align="left", out.width="75%"}
knitr::include_graphics("images/RUG-osmdata-pres/osm-interface-freedom-park.png")
```
...
That concludes this part. In [part 2](https://michaeldgarber.github.io/teach-r/osmdata-for-bikes-part-2), we'll dive into the R code.
