...
## Explore package info, specifically
...
I'm not going to print all installed packages, because the list is long, but that would be done by `sessioninfo::package_info("installed")`
