...
I mostly use packages that are a part of the tidyverse or which work well with the tidyverse (e.g., sf). The R universe has lots and lots of helpful and free online resources on those topics. Here are some resources that I'd recommend:
...
-   For **manipulating spatial data** (sf)
    ...
    -   sf home page and vignettes 1-4:
...
-   For **making maps** (mapview, tmap, ggplot2)
    ...
    -   Color palettes:
        ...
        -   viridis: <https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html>
            ...
            -   Note this is often the default option in mapview.
