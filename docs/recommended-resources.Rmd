...
I mostly use packages that are a part of the tidyverse or which work well with the tidyverse (e.g., sf). The R universe is brimming with helpful and free online resources on those topics. Here are some resources that I'd recommend:
