...
monte_carlo_sim_frozen = 1:100 %>% 
  ...
  mutate(
    ...
    prev = rtruncnorm( #truncated normal
      n=n(), 
      a=0, 
      b=1,
...
Now let's randomly vary values of the variables over several replications. In this code, we will create a function that will create new variables that will change.
...
Define the number of replications. Here, we are creating an integer vector ranging from 1 to 500.
