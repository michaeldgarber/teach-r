...
In [part 1](https://michaeldgarber.github.io/teach-r/osmdata-for-bikes-part-1), I described OpenStreetMap's data structure for bicycle infrastructure and paths. In this one, let's dive into some R code to manage and visualize those data.
...
library(ggmap)
#Note to self: my key is registered here:
#configure-r/configure_register_ggmap.R
```
...
For further reading, I'd suggest the article by Ferster & colleagues ([2020](https://www.tandfonline.com/doi/full/10.1080/15568318.2018.1519746)):
