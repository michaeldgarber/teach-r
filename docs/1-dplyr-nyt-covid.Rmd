...
*Author's ote: this material is an updated version of an earlier demo available here (<https://rpubs.com/michaeldgarber/dplyr_1>). I have left that link live, but this version is more current.*
...
# 3. Explore the NYT COVID-19 data using dplyr
...
That concludes this tutorial. In our next tutorial (<https://rpubs.com/michaeldgarber/dplyr_2_tidycensus_mapview>), we'll continue using dplyr and we'll introduce **tidycensus**, **mapview**, and **ggplot** to use census data to visualize incidence per population.
